...
requirements = ['boto3', 'setuptools', 'requests', 'requirements_parser', 'pysnow==0.7.4', 'ipaddress==1.0.22', 'pefile==2019.4.18', 'PyPDF4==1.27.0', 'paramiko==2.6.0', 'pygit2==0.28.2', 'pdfminer==20140328', 'cryptography==2.7']
